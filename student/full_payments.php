                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">List of all Full Payments for <?php echo $_SESSION['username']; ?> </h6>
                                    ...
                                    if (!mysqli_num_rows($query) > 0) {
                                        ...
                                        while ($rows = mysqli_fetch_array($query)) {
                                            echo '<tr>
                                                ...
                                                <td><a href="#" onclick="showImageModal(\'' . $rows['payment_id'] . '\', \'' . $rows['student_id'] . '\', \'' . $rows['course_id'] . '\', \'' . $rows['payment_date'] . '\', \'' . $rows['course_name'] . '\', \'' . $rows['student_name'] . '\', \'' . $rows['payment_amount'] . '\', \'' . $rows['payment_status'] . '\',\'' . $rows['payment_slip_path'] . '\');"><img src="' . $rows['payment_slip_path'] . '" alt="Payment Slip" style="max-width: 100px; max-height: 100px;"></a></td>                                                    
