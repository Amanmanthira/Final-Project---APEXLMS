               ...
               <div class="row">
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        echo '<a href="update_course.php?course_id=' . $row['course_id'] . '" class="btn btn-sm btn-primary ml-2 mt-2">Edit</a>';
                        echo '<a href="assign_lecturers.php?course_id=' . $row['course_id'] . '" class="btn btn-sm btn-secondary ml-2 mt-2">Assign Lecturers</a>';
                        echo '<button class="btn btn-sm btn-danger ml-2 mt-2  delete-course" data-course-id="' . $row['course_id'] . '">Delete</button>';
...
<h1>Inactive Courses</h1>
    ...
    if (mysqli_num_rows($inactiveQuery) > 0) {
        while ($inactiveRow = mysqli_fetch_assoc($inactiveQuery)) {
            ...
            echo '<a href="update_course.php?course_id=' . $inactiveRow['course_id'] . '" class="btn btn-sm btn-primary ml-2 mt-2">Edit</a>';
            echo '<a href="assign_lecturers.php?course_id=' . $inactiveRow['course_id'] . '" class="btn btn-sm btn-secondary ml-2 mt-2">Assign Lecturers</a>';
            echo '<a href="activate_course.php?course_id=' . $inactiveRow['course_id'] . '" class="btn btn-sm btn-success ml-2 mt-2">Activate</a>';
