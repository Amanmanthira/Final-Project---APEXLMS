...
if (isset($_POST['paymentID'], $_POST['paymentStatus'], $_POST['studentID'], $_POST['courseID'])) {
    ...
    // Check if the student already has a confirmed payment for the current course and installment
    ...
    if (mysqli_num_rows($checkInstallmentPaymentResult) > 0) {
        echo 'Student already has a confirmed payment for the first installment of the course'; // Return message if student already has a confirmed payment
    } else {
