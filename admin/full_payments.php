...
<body class="fix-header fix-sidebar">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">List of all Full Payments</h6>
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT cp.payment_id, cp.student_id, cp.course_id, cp.payment_amount, cp.payment_date, cp.payment_status_updated_date, cp.payment_slip_path, cp.payment_status, s.full_name AS student_name, c.course_name 
                                            FROM course_full_payments cp
                                    ...
                                    if (!mysqli_num_rows($query) > 0) {
                                        ...
                                        while ($rows = mysqli_fetch_array($query)) {
                                            echo '<tr>
                                                ...
                                                <td><a href="#" onclick="showImageModal(\'' . $rows['payment_id'] . '\', \'' . $rows['student_id'] . '\', \'' . $rows['course_id'] . '\', \'' . $rows['payment_date'] . '\', \'' . $rows['course_name'] . '\', \'' . $rows['student_name'] . '\', \'' . $rows['payment_amount'] . '\', \'' . $rows['payment_slip_path'] . '\');"><img src="' . $rows['payment_slip_path'] . '" alt="Payment Slip" style="max-width: 100px; max-height: 100px;"></a></td>                                                    
    ...
    window.location.href = 'full_payments.php';
}

    function showImageModal(paymentID, studentID, courseID, paymentDate, courseName, studentName, paymentAmount, imageSrc) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response === 'success') {
                ...
                // Close the modal after 2 seconds and redirect to full_payments.php
                setTimeout(function() {
