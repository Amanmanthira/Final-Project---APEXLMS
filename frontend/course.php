...
<html lang="en">
  <head>
    <title>APEX Institute of Management Services | Courses</title>
    <meta charset="utf-8">
        ...
        <div class="row">
            ...
            if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo '<div class="course align-self-stretch ftco-animate">';
                    echo '<a href="#" class="img" style="background-image: url(' . $row['course_image_square'] . ')"></a>';
                    echo '<div class="text p-4">';
                    echo '<p class="category"><span>' . $row['department_name'] . '</span></p>';
                    echo '<h3 class="mb-3">' . $row['course_name'] . '</h3>';
                    echo '<p>' . substr($row['course_description'], 0, 100) . '...</p>';
                    echo '<p class="category"> <span class="price">LKR ' . $row['course_fee'] . '</span></p>';
                    echo '<p><a href="../student/enroll.php?course_id=' . $row['course_id'] . '" class="btn btn-primary">Enroll now!</a></p>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }
