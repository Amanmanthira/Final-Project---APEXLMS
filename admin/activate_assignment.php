...
if(isset($_POST['assignmentId'])) {
    ...
    // Update the is_active field to 1 for the specified assignment ID
    $sql = "UPDATE assignments SET is_active = 1 WHERE assignment_id = '$assignmentId'";
    if (mysqli_query($db, $sql)) {
        echo "Assignment activated successfully.";
    } else {
        echo "Error activating assignment: " . mysqli_error($db);
    }
} else {
