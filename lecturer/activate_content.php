...
if(isset($_POST['contentId'])) {
    ...
    // Update the is_active field to 1 for the specified content ID
    $sql = "UPDATE content SET is_active = 1 WHERE content_id = '$contentId'";
    if (mysqli_query($db, $sql)) {
        echo "Content activated successfully.";
    } else {
        echo "Error activating content: " . mysqli_error($db);
    }
} else {
