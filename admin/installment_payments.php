                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">List of all Installment Payments</h6>
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                   ...
                                   WHERE cp.installment_number = 1";
                                        ...
                                        echo '<tr>
                                            ...
                                            <td><a href="#" onclick="showImageModal(\'' . $rows['payment_id'] . '\', \'' . $rows['student_id'] . '\', \'' . $rows['course_id'] . '\', \'' . $rows['installment_payment_date'] . '\', \'' . $rows['course_name'] . '\', \'' . $rows['student_name'] . '\', \'' . $rows['installment_amount'] . '\', \'' . $rows['installment_payment_slip_path'] . '\');"><img src="' . $rows['installment_payment_slip_path'] . '" alt="Payment Slip" style="max-width: 100px; max-height: 100px;"></a></td>                                                    
...
function updatePaymentStatus() {
    ...
    // Make AJAX request
    $.ajax({
        url: 'update_installment_payment.php', 
        type: 'POST',
        data: {
            paymentID: paymentID,
        ...
        success: function(response) {
            ...
            if (response === 'success') {
                ...
                // Close the modal after 2 seconds and redirect to installment_payments.php
                setTimeout(function() {
