...
<html lang="en">
  <head>
    <title>APEX Institute of Management Services | About </title>
    <meta charset="utf-8">
      ...
      <div class="container">
          <div class="row d-flex">
              ...
              <div class="col-md-6 pl-md-5 ftco-animate">
                  <h2 class="mb-4">Apex Institute Management Services is a Leading educational Institute in Sri Lanka.</h2>
                  <p>Since its inception in 2007, APEX INSTITUTE MANAGEMENT SERVICES (AIMS) has come a long way to secure its reputation not only in Sri Lanka but also globally as a distinguished training and educational partner specifically catering to the necessities of students from all walks in their professions such as school leavers, graduates, professional holdings execute and managerial positions as well as corporates in the manufacturing and services sectors who placed their trust on AIMS. AIMS is registered under the NAITA since 2010 and ISO 9001:2015 certified for providing professional education.</p>
                  <p>They have focused on developing integrated solutions to bridge the gap between operational and managerial level theoretical knowledge and practical approaches.</p>
              </div>
          </div>
      </div>
  </section>
